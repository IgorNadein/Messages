...
object ActivitiesConstant {
    ...
    const val NATIVES_IMPORT_VERSION = "nativesImportVersion"
    const val CURRENT_NATIVES_IMPORT_VERSION = 2
}
...
fun Context.getNativesLoaded(): Boolean {
    ...
    return sharedPreferences.getInt(ActivitiesConstant.NATIVES_IMPORT_VERSION, 0) >=
            ActivitiesConstant.CURRENT_NATIVES_IMPORT_VERSION
}
...
fun Context.setNativesLoaded(load: Boolean) {
    ...
    return sharedPreferences.edit {
        ...
        putInt(
            ActivitiesConstant.NATIVES_IMPORT_VERSION,
            if (load) ActivitiesConstant.CURRENT_NATIVES_IMPORT_VERSION else 0,
        )
    }
}
