...
fun Context.getThreadId(addresses: Collection<String>): Int {
    require(addresses.isNotEmpty()) { "At least one recipient is required" }
    return Telephony.Threads.getOrCreateThreadId(this, addresses.toSet()).toInt()
}
