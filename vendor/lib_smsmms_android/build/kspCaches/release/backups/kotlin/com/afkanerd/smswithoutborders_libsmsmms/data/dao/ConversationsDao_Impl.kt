...
public class ConversationsDao_Impl(
  ...
  init {
      ...
      protected override fun bind(statement: SQLiteStatement, entity: Conversations) {
        ...
        if (_tmpSms != null) {
          ...
          if (_tmp_id == null) {
            ...
            statement.bindLong(9, _tmp_id)
          }
          statement.bindLong(10, _tmpSms.thread_id.toLong())
          ...
          if (_tmpPerson == null) {
            ...
            statement.bindText(12, _tmpPerson)
          }
          statement.bindLong(13, _tmpSms.date)
          statement.bindLong(14, _tmpSms.date_sent)
          val _tmpProtocol: String? = _tmpSms.protocol
          if (_tmpProtocol == null) {
            statement.bindNull(15)
          } else {
            statement.bindText(15, _tmpProtocol)
          }
          statement.bindLong(16, _tmpSms.read.toLong())
          statement.bindLong(17, _tmpSms.status.toLong())
          statement.bindLong(18, _tmpSms.type.toLong())
          val _tmpReply_path_present: String? = _tmpSms.reply_path_present
          if (_tmpReply_path_present == null) {
            statement.bindNull(19)
          } else {
            statement.bindText(19, _tmpReply_path_present)
          }
          val _tmpSubject: String? = _tmpSms.subject
          if (_tmpSubject == null) {
            statement.bindNull(20)
          } else {
            statement.bindText(20, _tmpSubject)
          }
          val _tmpBody: String? = _tmpSms.body
          if (_tmpBody == null) {
            statement.bindNull(21)
          } else {
            statement.bindText(21, _tmpBody)
          }
          val _tmpService_center: String? = _tmpSms.service_center
          if (_tmpService_center == null) {
            statement.bindNull(22)
          } else {
            statement.bindText(22, _tmpService_center)
          }
          val _tmpLocked: Int? = _tmpSms.locked
          if (_tmpLocked == null) {
            statement.bindNull(23)
          } else {
            statement.bindLong(23, _tmpLocked.toLong())
          }
          statement.bindLong(24, _tmpSms.sub_id)
          val _tmpError_code: Int? = _tmpSms.error_code
          if (_tmpError_code == null) {
            statement.bindNull(25)
          } else {
            statement.bindLong(25, _tmpError_code.toLong())
          }
          val _tmpCreator: String? = _tmpSms.creator
          if (_tmpCreator == null) {
            statement.bindNull(26)
          } else {
            statement.bindText(26, _tmpCreator)
          }
          val _tmpSeen: Int? = _tmpSms.seen
          if (_tmpSeen == null) {
            statement.bindNull(27)
          } else {
            statement.bindLong(27, _tmpSeen.toLong())
          }
        } else {
          statement.bindNull(9)
    ...
    this.__insertAdapterOfConversations_1 = object : EntityInsertAdapter<Conversations>() {
      protected override fun createQuery(): String = "INSERT OR IGNORE INTO `Conversations` (`id`,`sms_data`,`secure_transport_text`,`mms_text`,`mms_content_uri`,`mms_mimetype`,`mms_filename`,`mms_filepath`,`_id`,`thread_id`,`address`,`person`,`date`,`date_sent`,`protocol`,`read`,`status`,`type`,`reply_path_present`,`subject`,`body`,`service_center`,`locked`,`sub_id`,`error_code`,`creator`,`seen`,`mms__id`,`mms_thread_id`,`mms_date`,`mms_date_sent`,`mms_msg_box`,`mms_read`,`mms_m_id`,`mms_sub`,`mms_sub_cs`,`mms_ct_t`,`mms_ct_l`,`mms_exp`,`mms_m_cls`,`mms_m_type`,`mms_v`,`mms_m_size`,`mms_pri`,`mms_rr`,`mms_rpt_a`,`mms_resp_st`,`mms_st`,`mms_tr_id`,`mms_retr_st`,`mms_retr_txt`,`mms_retr_txt_cs`,`mms_read_status`,`mms_ct_cls`,`mms_resp_txt`,`mms_d_tm`,`mms_d_rpt`,`mms_locked`,`mms_sub_id`,`mms_seen`,`mms_creator`,`mms_text_only`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    this.__updateAdapterOfConversations = object : EntityDeleteOrUpdateAdapter<Conversations>() {
      ...
      protected override fun bind(statement: SQLiteStatement, entity: Conversations) {
        ...
        statement.bindLong(63, entity.id)
      }
    }
    ...
    return performBlocking(__db, true, false) { _connection ->
      ...
      try {
        ...
        if (_stmt.step()) {
          ...
          _result = Conversations(_tmpId,_tmpSms,_tmpMms,_tmpSms_data,_tmpSecure_transport_text,_tmpMms_text,_tmpMms_content_uri,_tmpMms_mimetype,_tmpMms_filename,_tmpMms_filepath)
        } else {
          _result = null
        }
        _result
    ...
    return performBlocking(__db, true, false) { _connection ->
      ...
      try {
        ...
        while (_stmt.step()) {
          ...
          _item = Conversations(_tmpId,_tmpSms,_tmpMms,_tmpSms_data,_tmpSecure_transport_text,_tmpMms_text,_tmpMms_content_uri,_tmpMms_mimetype,_tmpMms_filename,_tmpMms_filepath)
          _result.add(_item)
        }
        _result
      } finally {
