...
public class ConversationsDao_Impl(
  ...
  private val __insertAdapterOfThreadParticipant: EntityInsertAdapter<ThreadParticipant>

  private val __insertAdapterOfConversations: EntityInsertAdapter<Conversations>

  private val __insertAdapterOfConversations_1: EntityInsertAdapter<Conversations>
  ...
  init {
    this.__db = __db
    this.__insertAdapterOfThreadParticipant = object : EntityInsertAdapter<ThreadParticipant>() {
      protected override fun createQuery(): String = "INSERT OR REPLACE INTO `ThreadParticipants` (`threadId`,`address`) VALUES (?,?)"

      protected override fun bind(statement: SQLiteStatement, entity: ThreadParticipant) {
    ...
    this.__insertAdapterOfConversations = object : EntityInsertAdapter<Conversations>() {
      ...
      protected override fun bind(statement: SQLiteStatement, entity: Conversations) {
        ...
        val _tmpSecure_transport_text: String? = entity.secure_transport_text
        if (_tmpSecure_transport_text == null) {
          statement.bindNull(3)
        } else {
          statement.bindText(3, _tmpSecure_transport_text)
        }
        val _tmpSender_address: String? = entity.sender_address
        if (_tmpSender_address == null) {
          statement.bindNull(4)
        } else {
          statement.bindText(4, _tmpSender_address)
        }
        val _tmpMms_text: String? = entity.mms_text
        if (_tmpMms_text == null) {
          statement.bindNull(5)
        } else {
          statement.bindText(5, _tmpMms_text)
        }
        val _tmpMms_content_uri: String? = entity.mms_content_uri
        if (_tmpMms_content_uri == null) {
          statement.bindNull(6)
        } else {
          statement.bindText(6, _tmpMms_content_uri)
        }
        val _tmpMms_mimetype: String? = entity.mms_mimetype
        if (_tmpMms_mimetype == null) {
          statement.bindNull(7)
        } else {
          statement.bindText(7, _tmpMms_mimetype)
        }
        val _tmpMms_filename: String? = entity.mms_filename
        if (_tmpMms_filename == null) {
          statement.bindNull(8)
        } else {
          statement.bindText(8, _tmpMms_filename)
        }
        val _tmpMms_filepath: String? = entity.mms_filepath
        if (_tmpMms_filepath == null) {
          statement.bindNull(9)
        } else {
          statement.bindText(9, _tmpMms_filepath)
        }
        ...
        if (_tmpSms != null) {
          ...
          if (_tmp_id == null) {
            ...
            statement.bindLong(10, _tmp_id)
          }
          statement.bindLong(11, _tmpSms.thread_id.toLong())
          val _tmpAddress: String? = _tmpSms.address
          if (_tmpAddress == null) {
            statement.bindNull(12)
          } else {
            statement.bindText(12, _tmpAddress)
          }
          val _tmpPerson: String? = _tmpSms.person
          if (_tmpPerson == null) {
            statement.bindNull(13)
          } else {
            statement.bindText(13, _tmpPerson)
          }
          statement.bindLong(14, _tmpSms.date)
          statement.bindLong(15, _tmpSms.date_sent)
          val _tmpProtocol: String? = _tmpSms.protocol
          if (_tmpProtocol == null) {
            statement.bindNull(16)
          } else {
            statement.bindText(16, _tmpProtocol)
          }
          statement.bindLong(17, _tmpSms.read.toLong())
          statement.bindLong(18, _tmpSms.status.toLong())
          statement.bindLong(19, _tmpSms.type.toLong())
          val _tmpReply_path_present: String? = _tmpSms.reply_path_present
          if (_tmpReply_path_present == null) {
            statement.bindNull(20)
          } else {
            statement.bindText(20, _tmpReply_path_present)
          }
          val _tmpSubject: String? = _tmpSms.subject
          if (_tmpSubject == null) {
            statement.bindNull(21)
          } else {
            statement.bindText(21, _tmpSubject)
          }
          val _tmpBody: String? = _tmpSms.body
          if (_tmpBody == null) {
            statement.bindNull(22)
          } else {
            statement.bindText(22, _tmpBody)
          }
          val _tmpService_center: String? = _tmpSms.service_center
          if (_tmpService_center == null) {
            statement.bindNull(23)
          } else {
            statement.bindText(23, _tmpService_center)
          }
          val _tmpLocked: Int? = _tmpSms.locked
          if (_tmpLocked == null) {
            statement.bindNull(24)
          } else {
            statement.bindLong(24, _tmpLocked.toLong())
          }
          statement.bindLong(25, _tmpSms.sub_id)
          val _tmpError_code: Int? = _tmpSms.error_code
          if (_tmpError_code == null) {
            statement.bindNull(26)
          } else {
            statement.bindLong(26, _tmpError_code.toLong())
          }
          val _tmpCreator: String? = _tmpSms.creator
          if (_tmpCreator == null) {
            statement.bindNull(27)
          } else {
            statement.bindText(27, _tmpCreator)
          }
          val _tmpSeen: Int? = _tmpSms.seen
          if (_tmpSeen == null) {
            statement.bindNull(28)
          } else {
            statement.bindLong(28, _tmpSeen.toLong())
          }
        } else {
          statement.bindNull(10)
    ...
    this.__insertAdapterOfConversations_1 = object : EntityInsertAdapter<Conversations>() {
      protected override fun createQuery(): String = "INSERT OR IGNORE INTO `Conversations` (`id`,`sms_data`,`secure_transport_text`,`sender_address`,`mms_text`,`mms_content_uri`,`mms_mimetype`,`mms_filename`,`mms_filepath`,`_id`,`thread_id`,`address`,`person`,`date`,`date_sent`,`protocol`,`read`,`status`,`type`,`reply_path_present`,`subject`,`body`,`service_center`,`locked`,`sub_id`,`error_code`,`creator`,`seen`,`mms__id`,`mms_thread_id`,`mms_date`,`mms_date_sent`,`mms_msg_box`,`mms_read`,`mms_m_id`,`mms_sub`,`mms_sub_cs`,`mms_ct_t`,`mms_ct_l`,`mms_exp`,`mms_m_cls`,`mms_m_type`,`mms_v`,`mms_m_size`,`mms_pri`,`mms_rr`,`mms_rpt_a`,`mms_resp_st`,`mms_st`,`mms_tr_id`,`mms_retr_st`,`mms_retr_txt`,`mms_retr_txt_cs`,`mms_read_status`,`mms_ct_cls`,`mms_resp_txt`,`mms_d_tm`,`mms_d_rpt`,`mms_locked`,`mms_sub_id`,`mms_seen`,`mms_creator`,`mms_text_only`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    this.__insertAdapterOfThreads = object : EntityInsertAdapter<Threads>() {
      protected override fun createQuery(): String = "INSERT OR REPLACE INTO `Threads` (`threadId`,`address`,`snippet`,`date`,`type`,`conversationId`,`isMms`,`isMute`,`isArchive`,`isBlocked`,`unread`,`isPinned`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    this.__updateAdapterOfConversations = object : EntityDeleteOrUpdateAdapter<Conversations>() {
      ...
      protected override fun bind(statement: SQLiteStatement, entity: Conversations) {
        ...
        statement.bindLong(64, entity.id)
      }
    }
  ...
  public override fun insertThreadParticipants(participants: List<ThreadParticipant>): Unit = performBlocking(__db, false, true) { _connection ->
    __insertAdapterOfThreadParticipant.insert(_connection, participants)
  }

  public override fun insertConversation(conversation: Conversations): Long = performBlocking(__db, false, true) { _connection ->
    val _result: Long = __insertAdapterOfConversations.insertAndReturnId(_connection, conversation)
    _result
  }

  public override fun insertConversations(conversation: List<Conversations>): Unit = performBlocking(__db, false, true) { _connection ->
    __insertAdapterOfConversations_1.insert(_connection, conversation)
  }

  public override fun insertThread(thread: Threads): Unit = performBlocking(__db, false, true) { _connection ->
    __insertAdapterOfThreads.insert(_connection, thread)
  }

  public override fun insertThreads(thread: List<Threads>): Unit = performBlocking(__db, false, true) { _connection ->
    __insertAdapterOfThreads.insert(_connection, thread)
  }

  public override fun deleteConversation(conversations: Conversations): Unit = performBlocking(__db, false, true) { _connection ->
    __deleteAdapterOfConversations.handle(_connection, conversations)
  }

  public override fun deleteConversations(conversations: List<Conversations>): Unit = performBlocking(__db, false, true) { _connection ->
    __deleteAdapterOfConversations.handleMultiple(_connection, conversations)
  }

  public override fun updateConversation(conversations: Conversations): Unit = performBlocking(__db, false, true) { _connection ->
    __updateAdapterOfConversations.handle(_connection, conversations)
  }

  public override fun updateThread(thread: Threads): Unit = performBlocking(__db, false, true) { _connection ->
    __updateAdapterOfThreads.handle(_connection, thread)
  }

  public override fun update(conversations: MutableList<Conversations>): Int = performBlocking(__db, false, true) { _connection ->
    var _result: Int = 0
    _result += __updateAdapterOfConversations.handleMultiple(_connection, conversations)
    _result
  }

  public override fun replaceThreadParticipants(threadId: Int, addresses: Collection<String>): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.replaceThreadParticipants(threadId, addresses)
  }

  public override fun update(conversation: Conversations): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.update(conversation)
  }

  public override fun insert(conversation: Conversations, removeArchive: Boolean): Long = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.insert(conversation, removeArchive)
  }

  public override fun insertAllThreads(conversationsList: List<Conversations>, isMms: Boolean): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.insertAllThreads(conversationsList, isMms)
  }

  public override fun insertAll(conversationsList: List<Conversations>, deleteDb: Boolean): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.insertAll(conversationsList, deleteDb)
  }

  public override fun delete(conversation: Conversations, removeArchive: Boolean): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.delete(conversation, removeArchive)
  }

  public override fun delete(conversations: List<Conversations>, removeArchive: Boolean): Unit = performBlocking(__db, false, true) { _ ->
    super@ConversationsDao_Impl.delete(conversations, removeArchive)
  }

  public override fun getThreadParticipantAddresses(threadId: Int): List<String> {
    val _sql: String = "SELECT address FROM ThreadParticipants WHERE threadId = ? ORDER BY address"
    ...
    return performBlocking(__db, true, false) { _connection ->
      ...
      try {
        ...
        if (_stmt.step()) {
          ...
          _result = Conversations(_tmpId,_tmpSms,_tmpMms,_tmpSms_data,_tmpSecure_transport_text,_tmpSender_address,_tmpMms_text,_tmpMms_content_uri,_tmpMms_mimetype,_tmpMms_filename,_tmpMms_filepath)
        } else {
          _result = null
        }
        _result
  ...
  public override fun getPotentialUndecryptedSecureMessages(): List<Conversations> {
    val _sql: String = "SELECT * FROM Conversations WHERE type = 1 AND (body LIKE 'Ayg%' OR body LIKE 'AwAC%') ORDER BY date ASC"
    return performBlocking(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        val _columnIndexOfId: Int = getColumnIndexOrThrow(_stmt, "id")
        ...
        while (_stmt.step()) {
          ...
          _item = Conversations(_tmpId,_tmpSms,_tmpMms,_tmpSms_data,_tmpSecure_transport_text,_tmpSender_address,_tmpMms_text,_tmpMms_content_uri,_tmpMms_mimetype,_tmpMms_filename,_tmpMms_filepath)
          _result.add(_item)
        }
        _result
      } finally {
  ...
  public override fun getStoredSecureDecryptionFailures(failureText: String): List<Conversations> {
    val _sql: String = "SELECT * FROM Conversations WHERE type = 1 AND secure_transport_text IS NOT NULL AND body = ?"
    return performBlocking(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
        _stmt.bindText(_argIndex, failureText)
        val _columnIndexOfId: Int = getColumnIndexOrThrow(_stmt, "id")
        val _columnIndexOfSmsData: Int = getColumnIndexOrThrow(_stmt, "sms_data")
        val _columnIndexOfSecureTransportText: Int = getColumnIndexOrThrow(_stmt, "secure_transport_text")
        val _columnIndexOfSenderAddress: Int = getColumnIndexOrThrow(_stmt, "sender_address")
  ...
  public override fun getConversations(threadId: Int): PagingSource<Int, Conversations> {
    val _sql: String = "SELECT * FROM Conversations WHERE thread_id = ? OR Conversations.mms_thread_id = ? ORDER BY date DESC"
  ...
  public override fun fetchConversationsForType(threadId: Int, type: Int): Conversations? {
    val _sql: String = "SELECT * FROM Conversations WHERE (thread_id = ? OR Conversations.mms_thread_id = ?) AND type = ? ORDER BY  date DESC LIMIT 1"
    return performBlocking(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override fun getLatestConversation(threadId: Int): Conversations? {
    val _sql: String = "SELECT * FROM Conversations WHERE (thread_id = ? OR Conversations.mms_thread_id = ?) ORDER BY date DESC LIMIT 1"
    return performBlocking(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override fun deleteThreadParticipants(threadId: Int) {
    val _sql: String = "DELETE FROM ThreadParticipants WHERE threadId = ?"
  ...
  public override fun updateThreadAddress(threadId: Int, address: String) {
    val _sql: String = "UPDATE Threads SET address = ? WHERE threadId = ?"
    return performBlocking(__db, false, true) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override fun deleteAllAddressConversations(address: String) {
    val _sql: String = "DELETE FROM Conversations WHERE address like ? || '%'"
    return performBlocking(__db, false, true) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override fun deleteAllThreads(address: String) {
    val _sql: String = "DELETE FROM Conversations WHERE address like ? || '%'"
    return performBlocking(__db, false, true) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
